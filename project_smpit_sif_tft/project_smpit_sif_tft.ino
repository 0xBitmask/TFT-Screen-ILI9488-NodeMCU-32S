...
//   RST  = 4
//
// PIN DI KONFIGURASI TFT_eSPI/User_Setup.h
//
// RFID: MFRC522 (SS diganti agar tidak bentrok dengan CS TFT)
//   SS  = 15
//   RST = 14
//   SCK = 18, MISO = 19, MOSI = 23 (berbagi bus SPI dengan TFT)
//
// BUZZER = 16
...
void drawRFIDIcon(
  ...
  tft.drawArc(cx + 32, cy, 12, 9, 250, 290, color, COL_BG);
  tft.drawArc(cx + 32, cy, 20, 17, 250, 290, color, COL_BG);
  tft.drawArc(cx + 32, cy, 28, 25, 250, 290, color, COL_BG);
}
...
void drawWifiIndicator() {
  ...
  tft.fillSmoothCircle(415, 32, 7, c, COL_HEADER);
  drawCentered(
    on ? "WiFi OK" : "WiFi OFF",
    450, 32,
    &FreeSansBold9pt7b,
